...
<div class="container mx-auto px-6 lg:px-12 xl:16 py-8">
        ...
        <div class="xs:justify-between mx-auto flex xl:flex-wrap sm:p-4 flex-col xl:flex-row items-center relative">
            ...
            <div class="xl:flex-1 mb-6 xl:mb-0">
                <div class=" mr-auto">
                    @if (has_nav_menu('secondary_navigation'))
                        {!! wp_nav_menu([
                            'theme_location' => 'secondary_navigation',
                            'menu_class' => 'text-center xl:text-left xl:flex',
...
{{--                <p class="text-xs uppercase">&copy; {{ App::currentYear() }} {{  App::siteName() }}</p>--}}
            ...
            <div class="xl:flex-1 mb-6 xl:mb-0 justify-center text-center md:ml-auto md:mr-auto ">
            <a href="/">
